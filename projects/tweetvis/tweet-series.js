function create_series_vis(symbols, div_id) {
...
*/
  ...
  y = d3.scale.linear().range([h / num_series - 20, 0]);
  setTimeout(lines, duration);
  //setTimeout(streamgraph, duration);
  //setTimeout(areas, duration);
  ...
  function lines() {
    ...
    symbols.forEach(function(d, i) {
      //svg.append("rect")
      //  .attr("width", w-m[1])
      //  .attr("height", (h/num_series)-20)
      //  .attr("transform", "translate(0," + (i * h / num_series + 10) + ")");

//      console.log("creating an axis " + d.key + " i=" + i);
      y.domain([0, d.maxPrice]);
      var yAxis = d3.svg.axis()
          .scale(y)
          .tickValues([0, d.maxPrice/2, d.maxPrice])
          .orient("left")
          .tickSize( -(w - (m[1] + m[3])) );
    ...
    var g = svg.selectAll(".symbol")
        .attr("transform", function(d, i) { return "translate(0," + (i * h / num_series + 10) + ")"; });
...
//        if (k == 1) {
//          console.log("creating an axis " + d.key);
//          // create the y axis
//          var yAxis = d3.svg.axis()
//              .scale(y)
//              .tickValues([0,d.maxPrice])
//              .orient("left");
//
//          g.append("g")
//            .attr("class", "axis")
